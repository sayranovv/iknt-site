        ...
        <div class="mt-32 flex flex-col gap-y-[500px]">
          ...
          <div class="flex gap-20 px-10 flex-nowrap">
            ...
            <div class="w-1/2">
              ...
              ></div>
              <p class="mt-5 text-xl font-light leading-tight">
                Учебные планы составлены на основе вакансий при участии ведущих ИТ-компаний. Участие
                в командных проектах с первого курса под руководством опытных менторов
              </p>
            </div>
          </div>
        </div>
