  ...
  >
    ...
    <div class="w-full">
      ...
      <table class="w-full text-center mt-4">
        <thead>
          <tr class="border-b">
            <td class="p-1 border-r last:border-r-0 w-1/3">Минимум</td>
            <td class="p-1 border-r last:border-r-0 w-1/3">Средний</td>
            <td class="p-1 border-r last:border-r-0 w-1/3">Максимум</td>
          </tr>
        </thead>
        <tbody>
          <tr class="font-light">
