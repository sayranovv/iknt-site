...
<template>
  <div>
    ...
    <!--      </p>-->
    <!--    </div>-->
    <div class="mt-12 text-center rounded-lg bg-white bg-opacity-10 flex flex-col w-1/2 mx-auto">
      <p
        @click="buttonClick(null)"
      ...
      <p
        @click="buttonClick('Бакалавриат')"
        class="cursor-pointer border-r border-l py-2 px-2.5 hover:border-blue-400 hover:shadow-[0px_0px_30px_10px_rgba(0,0,255,0.4)] backdrop-blur-2xl transition-all before:absolute before:inset-0 before:bg-blue-500 before:opacity-0 hover:before:opacity-20"
        :class="
          activeTab === 'Бакалавриат'
            ? [
                'z-10',
      ...
      <p
        @click="buttonClick('Специалитет')"
        class="cursor-pointer border-l border-r py-2 px-2.5 hover:border-fuchsia-400 hover:shadow-[0px_0px_30px_10px_rgba(255,0,255,0.4)] backdrop-blur-2xl transition-all before:absolute before:inset-0 before:bg-fuchsia-500 hover:before:opacity-20"
        :class="
          activeTab === 'Специалитет'
            ? [
                'z-10',
      ...
      <p
        @click="buttonClick('Магистратура')"
        class="cursor-pointer border-b border-l border-r rounded-b-lg px-4 py-2 hover:border-orange-400 hover:shadow-[0px_0px_30px_10px_rgba(255,150,0,0.4)] backdrop-blur-2xl transition-all before:absolute before:inset-0 before:bg-orange-500 before:rounded-b-lg before:opacity-0 hover:before:opacity-20"
        :class="
          activeTab === 'Магистратура'
            ? [
                'z-10',
